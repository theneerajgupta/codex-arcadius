...
const MobileNavbar = ({ isMenuOpen, onClick }: MobileNavbarProps) => {
  ...
  return (
    <div className='sticky top-0 z-50 bg-background p-2 mb-2 w-full texture-diagonal-1 border-accent border-2 md:hidden flex flex-row justify-between items-center'>
      <div>
        <h3>Neeraj Gupta</h3>
